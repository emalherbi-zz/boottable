...
(function ($) {
  ...
  $.Table.boot = function (el, header, values, options) {
    ...
    base.addAll = function () {
      ...
      base.clr(); /* clear */
      if (base.header.length === 0) {
        /* if not found a record, a message is automatically add */
  ...
  // OK
  $.fn.bTInit = function (filter, selected) {
    return this.bootTableInit(filter, selected);
  };
  ...
  // OK
  $.fn.bTLoader = function () {
    return this.bootTableLoader();
  };
  ...
  // OK
  $.fn.bTAddAll = function (header, values) {
    return this.bootTableAddAll(header, values);
  };
  ...
  // OK
  $.fn.bTAddAllJson = function (values) {
    return this.bootTableAddAllJson(values);
  };
  ...
  // OK
  $.fn.bTCalculateColumn = function (params) {
    return this.bootTableCalculateColumn(params);
  };
  ...
  // OK
  $.fn.bTCalculateColumnByField = function (params) {
    return this.bootTableCalculateColumnByField(params);
  };
  ...
  // OK
  $.fn.bTGetSelectedItem = function () {
    return this.bootTableGetSelectedItem();
  };
  ...
  // OK
  $.fn.bTGetItens = function () {
    return this.bootTableGetItens();
  };
  ...
  // OK
  $.fn.bTGetItensByColumn = function (params) {
    return this.bootTableGetItensByColumn(params);
  };
  ...
  // OK
  $.fn.bTGetItensByField = function (params) {
    return this.bootTableGetItensByField(params);
  };
  ...
  // OK
  $.fn.bTGetItensCount = function (params) {
    return this.bootTableGetItensCount(params);
  };
  ...
  // OK
  $.fn.bTHideColumn = function (params) {
    return this.bootTableHideColumn(params);
  };
  ...
  // OK
  $.fn.bTHideColumnByField = function (params) {
    return this.bootTableHideColumnByField(params);
  };
  ...
  // OK
  $.fn.bTShowColumn = function (params) {
    return this.bootTableShowColumn(params);
  };
  ...
  // OK
  $.fn.bTShowColumnByField = function (params) {
    return this.bootTableShowColumnByField(params);
  };
  ...
  // OK
  $.fn.bTFixHead = function () {
    return this.bootTableFixHead();
  };
  ...
  // OK
  $.fn.bTFixHeadFoot = function () {
    return this.bootTableFixHeadFoot();
  };
